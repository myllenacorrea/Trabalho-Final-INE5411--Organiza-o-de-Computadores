...
msg2:         .asciiz "Combustível:\n"           # Aqui deverá ser escrito o tipo de combustível
msg3:         .asciiz " Quantidade:"            # Aqui deverá ser escrito a quantidade de litros
msg4:         .asciiz " litros\n"
msg5:         .asciiz " Preço por litro: R$ \n" # Aqui deverá ser escrito o preço por litro
